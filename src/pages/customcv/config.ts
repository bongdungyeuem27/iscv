...
export const customStyles = {
  ...
  control: (_: any, { selectProps: { onFocus } }: any) => ({
...
export const defaultStyle = (item: any) => {
  return {
...
export const defaultImageStyle = (item: any) => {
  return {
    objectFit: item.objectFit.value,
  };
};

export const defaultInTextStyle = (item: any) => {
  return {
